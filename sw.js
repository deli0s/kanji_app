const CACHE='kanji-kori-v5';
const ASSETS=['./','./index.html','./manifest.webmanifest','./css/app.css','./js/app.js','./js/db.js','./js/router.js','./js/data.js','./js/kanji-catalog.js','./js/lesson.js','./js/stroke.js','./data/curriculum.json','./data/kana.json','./assets/icon.svg'];
